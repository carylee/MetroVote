...
position1 = Position.create(:title => "Council Seat 1", :election_id => seattleElections.id, :region_number => 1)
position3 = Position.create(:title => "Council Seat 3", :election_id => seattleElections.id, :region_number => 3)
position5 = Position.create(:title => "Council Seat 5", :election_id => seattleElections.id, :region_number => 5)
position7 = Position.create(:title => "Council Seat 7", :election_id => seattleElections.id, :region_number => 7)
position9 = Position.create(:title => "Council Seat 9", :election_id => seattleElections.id, :region_number => 9)

Candidate.create(:name => "Bobby Forch",
                 :website => "http://bobbyforch.com",
                 :bio => "Current: Seattle Department of Transportation, Contracting Equity and Compliance Manager, helping small businesses with the city's contracting processes

SDOT laborer in Local 1239, SDOT Safety, Health and Environmental Mangaer, city's contracting manager",
                 :twitter => "BobbyForch",
...
Candidate.create(:name => "Jean Godden",
                 ...
                 :bio => "Current: Member of Seattle City Council since 2004.

Balancing our city's budget, bringing new jobs to the region and protecting our environment.",
